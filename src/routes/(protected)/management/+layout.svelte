		...
		<div class="shrink-0 p-4">
			<div class="rounded-lg border border-border bg-card p-3 shadow-sm">
				<div class="flex items-center gap-2">
					...
					<div>
						<div class="font-semibold text-foreground">Management</div>
			...
			<Drawer.Content class="flex h-screen w-80 flex-col">
				<Drawer.Header class="shrink-0 px-4 pt-6">
					<div class="flex items-center gap-2">
						...
						<div>
							<Drawer.Title class="text-lg">Management Portal</Drawer.Title>
						</div>
					</div>
				</Drawer.Header>
				...
				<div class="flex min-h-0 flex-1 flex-col">
					...
					<div class="shrink-0 border-t border-border p-4">
						<div class="mb-4">
							<p class="text-sm font-medium text-foreground">Management User</p>
